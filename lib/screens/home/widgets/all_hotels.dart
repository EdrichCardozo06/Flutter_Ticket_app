        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(hotel['place'], style: AppStyles.headLineStyle3.copyWith(color : AppStyles.kakiColour),),
            ),
            Row(
              children: [
                Padding(
                ...
                Padding(
                  ...
                  child: Text('Rs ${hotel['price'].toString()}', style: AppStyles.headLineStyle4.copyWith(color : AppStyles.kakiColour),),
                )
              ],
            )
          ],
